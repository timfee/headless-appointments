...
(() => {
  ...
  var AvailabilityContext = (0, import_react.createContext)({
    dispatch: () => null,
    state: INITIAL_STATE
  });
  function AvailabilityProvider({
    ...
    const [state, dispatch] = (0, import_react.useReducer)(reducer, __spreadProps(__spreadValues({}, INITIAL_STATE), {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvailabilityContext.Provider, { value: { dispatch, state }, children });
  }
  function useAvailabilityContext() {
    if (!(0, import_react.useContext)(AvailabilityContext))
      throw new Error(
        "AvailabilityContext is not defined. Did you forget to wrap your component in AvailabilityProvider?"
      );
    return (0, import_react.useContext)(AvailabilityContext);
  }
})();
